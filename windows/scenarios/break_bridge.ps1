# break_bridge.ps1 - Corrupts Docker's default bridge network
#
...
# live inside the Docker Desktop VM (WSL2 or Hyper-V backend), not on the
# Windows host.
#
...
Write-Host "Symptoms: Containers can't reach each other or internet"
