...
# via docker-credential-desktop, which erases the entry from the macOS
# Keychain. After Docker Desktop restarts with the broken proxy config,
# the trainee will be prompted to sign in. Their SSO attempt will loop
# because hub.docker.com is blocked by the bogus proxy.
# ------------------------------------------------------------------
